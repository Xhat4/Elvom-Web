...
<nav class="navbar3 w-100 fixed-top text-center navbarNonTransparent">
    ...
    <div class="d-flex flex-nowrap">
        ...
        <%
            ...
            ArrayList<user> artist = (ArrayList<user>) session.getAttribute("artist");
        %>
        <div>
...
<section class="h-100 py-5">
    <div class="d-flex justify-content-center">
        <div class="d-block">
            <p class="h1 text-center">Artistas</p>
            <div class="mb-3 mt-4 d-flex justify-content-evenly">
                <%
                    for(int i = 0; i < artist.size(); i++){
                %>
                <div class="card" style="width: 180px;">
                    <img src="<%= artist.get(i).getImage() %>" class="card-img-top" height="150px" width="150px">
                    <div class="card-body">
                        <h5 class="card-title"><%= artist.get(i).getUsername() %></h5>
                        <p>E-mail: <%= artist.get(i).getEmail() %></p>
